  ...
  return (
    <>
     <div className="relative h-[300px] md:h-[400px] overflow-hidden rounded-lg mx-4 mt-4">
        ...
        />
        <div className="absolute inset-0 bg-opacity-30 p-6 flex flex-col justify-center items-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-2">We are CropFresh</h1>
          <span className="text-xl md:text-3xl font-bold text-white mb-2">
            Our job is connecting hard working producers with good, honest clients anywhere, everywhere.
          </span>
        </div>
    </div>
